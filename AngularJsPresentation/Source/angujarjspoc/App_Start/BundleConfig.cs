...
namespace ASP.NET_MVC5_Bootstrap3_3_1_LESS
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            var cssBundle = new StyleBundle("~/bundles/css");
            cssBundle.Include("~/Content/bootstrap/bootstrap.css", "~/Content/bootstrap/bootstrap-theme.css");
            cssBundle.Transforms.Add(cssTransformer);
            cssBundle.Orderer = nullOrderer;
            bundles.Add(cssBundle);
            ...
            angularBundle.Include("~/Scripts/angular.js", "~/Scripts/angular-route.js", "~/Scripts/angular-resource.js");
